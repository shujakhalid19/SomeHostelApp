    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xs-10 md-top-30">
                <h2 class='b'>Events and Places.<br/></h2>
                <h3>Events and Places can be a great way to find more customers.</h3>
                <h3>Add Fun Places and Events near your Listing.</h3>
                <br/>
                <button class="btn btn-lg btn-primary" data-toggle="modal" data-target="#myModal">Create New</button> 
            </div>
