...
<div class="col-xs-12 col-md-12 xs-hide" style="background-color:#e6e6fa51 ; height:50px;padding:10px;margin-bottom:20px;">asd</div>

<div class="tab-content">
                  <div id="home" class="tab-pane fade col-xs-12 col-sm-12 col-md-12 in active">
                  <h3 class="md-top-20 bd-rt-blue" style="margin-bottom:20px;"><?=$seller_det['name'];?>
...
<div id="cards" class="col-md-12 col-sm-12 col-xs-12">
    <div class="col-xs-12 col-sm-12 col-md-12" style="padding:0px;">
      <div class="card-6 col-md-3 col-sm-4 col-xs-12 bd">
                           <div class="card">
                              <div class="card-header">
                                <h2 class="cl-blue b">22</h2>
                                  
                              </div>
                              <div class="card-body" style="padding-top:2px;">
                                
                                <h5 class="card-title b"> Arrivals</h5>
                                <br/>
                        ...
                        <div class="card-6 col-md-3 col-sm-4 col-xs-12 bd">
                           <div class="card">
                              <div class="card-header">
                                <h2 class="text-danger b">12</h2>
                                  
                              </div>
                              <div class="card-body" style="padding-top:2px;">
                                
                                <h5 class="card-title b"> Departures</h5>
                                <br/>
                        ...
                        <div class="card-6 col-md-3 col-sm-4 col-xs-12 bd">
                           <div class="card">
                              <div class="card-header">
                                <h2 class="text-success b">4</h2>
                                  
                              </div>
                              <div class="card-body" style="padding-top:2px;">
                                
                                <h5 class="card-title b"> Rooms Occupied</h5>
                                <br/>
...
<a href="../new.php" class="list-group-item list-group-item-action flex-column align-items-start ">
                              ...
                              <div class="card-body">
                                ...
                                <p class="card-text f-10">Create a new listing in few simple steps.</p>
        ...
        <div class="card-6 col-md-5 col-sm-4 col-xs-12 list-group-item">
                ...
                <div class="card-header" style="padding:0px;">
                    ...
                    <img  src="../profiles/<?=str_replace(' ', '_', $seller_det['name']).'_'.$seller_det['im_'.$i];?>" style="width:100%;height:200px;object-fit:cover;" />
                    </div>
                    <?php
                           }else{
                         ?>
                    <div class="col-md-3 col-xs-6" style="margin:0px;padding:1px;">
                    <img   src="../profiles/<?=str_replace(' ', '_', $seller_det['name']).'_'.$seller_det['im_'.$i];?>" style="width:100%;height:100px;object-fit:cover;" />
                    </div>
            ...
            <div class="col-md-12 col-xs-12">
                <h3 class="b">Hostel Gallery</h3>
                 ...
                 <button class="btn btn-md btn-pill" style="background-color:rgba(100,149,237,0.1); border:2px solid cornflowerblue;" onclick="myGallery(<?=$seller_det['id'];?>)"><i class="fa fa-plus"></i> Add More </button>
                          ...
                          <!--EVENTS-->    
     <div class="card-6 col-md-3 col-sm-4 col-xs-12" style="padding:0px;">
<a href="events.php" class="list-group-item list-group-item-action flex-column align-items-start ">
                              <div class="card text-center" style="border-radius:14px!important;">
                              <div class="card-header">
                              ...
                              <div class="card-body">
                                ...
                                <p class="card-text f-10">Events and places near you.Events and places are a great way to attract more customers.</p>
                                  ...
                                  <button class="btn btn-primary btn-md btn-pill"><i class="fa fa-plus"></i> Start here</button>
    ...
    <!--ACCC-->
    <div id="account" class="tab-pane fade col-xs-12 col-sm-12 col-md-12">
    <h3 class="md-top-20 bd-rt-blue" style="margin-bottom:10px;">New Bookings
            <span class="pull-right" data-toggle="modal" data-target="#myDetails"><i class="fa fa-edit"></i></span>
        </h3>
        <div id="cards" class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
             ...
             <div class="card-6 col-md-4 col-sm-4 col-xs-12 list-group-item " style="padding:10px;">
                    ...
                    <div style="padding:20px 5px 5px 5px;">
                        <span class="b">Property Type</span>
                        <span id="<?=$comp->clean_encode('type');?>" class="pull-right"><?=$seller_det['type'];?></span>
                    </div>
                    ...
                    <div style="padding:20px 5px 5px 5px;">
                        ...
                        <div class="md-top-20" id="<?=$comp->clean_encode('address');?>" class="pull-right"><?=$seller_det['address'];?></div>
                        
                    </div>
                 <div style="padding:20px 5px 5px 5px;">
                        <span class="b">City</span>
                        <span id="<?=$comp->clean_encode('city');?>" class="pull-right"><?=$seller_det['city'];?></span>
                    </div>
                 <div style="padding:20px 5px 5px 5px;">
                        <span class="b">Country</span>
                        <span class="pull-right"><?=$seller_det['country'];?></span>
                    </div>
                 
                 <div style="padding:20px 5px 5px 5px;">
                        <span class="b">Zip Code</span>
                        <span id="<?=$comp->clean_encode('zip');?>" class="pull-right"><?=$seller_det['zip'];?></span>
                    </div>
    ...
    <!--//ACC-->
                  ...
                  <div id="edit" class="tab-pane fade col-xs-12 col-sm-12 col-md-12">
                    <h3 class="md-top-20" style='padding:0px;'>Edit Listing
                        ...
                        <h4 class="b">Description</h4>        
                            <br/>
                            <p id="<?=$comp->clean_encode('readableDesc');?>">
                                    <?=$seller_det['description'];?>
                            </p>
                        </div>
...
-->
    ...
    <!--ROOMS-->
    <div id="rooms" class="tab-pane fade col-xs-12 col-sm-12 col-md-12">
         <h3 class="md-top-20" style="padding:0px;margin-bottom: 20px;">Rooms
            ...
            <div id="table" class="col-md-12 col-sm-12 col-xs-12 md-top-10" style="padding:0px;">
                        ...
                        <div id="SharedRooms" class="col-xs-12" style="padding:0px;">
                            <h4 class="b bd-rt-blue" style="margin-bottom: 30px;">Shared Rooms</h4>
                        </div>
                        <div id="PrivateRooms" class="col-xs-12 md-top-40" style="padding:0px;">
    ...
    <!--//ROOMS-->
                  ...
                  <div id="books" class="tab-pane fade col-xs-12 col-sm-12 col-md-12">

                        <h3 class="md-top-20 bd-rt-blue" style="margin-bottom:20px;">New Bookings</h3>


                        <div id="table" class="col-md-12 col-xs-12" style="padding:0px;">
                        

                          <div class="card-6 col-md-12 col-sm-4 col-xs-12" style="padding:0px;">
                      <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 justify-content-between">
                                  <h5 class="b">Guest: <span class=" cl-blue">Locas Exponent</span></h5>
                                  
                                </div>
                                <p class="mb-1"><strong>Booking Id</strong>: 248234erwerw2</p>
                                <p class="mb-1"><strong>Status:</strong> Pending</p>
                                <p class="mb-1"><strong>Check-In</strong>: 23 Nov, 2020</p>
                                <p class="mb-1"><strong>Check-Out:</strong> 28 Nov, 2020</p>
                                <div>
          ...
          for($i=1;$i<=10;$i++){
          ?>
                           <div class="card-6 col-md-3 col-sm-4 col-xs-12" style="margin:0px;padding:0px;">
                      <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 justify-content-between">
                                  <h5 class="b">Guest: <span class=" cl-blue">Locas Exponent</span></h5>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="b" id="<?=$comp->clean_encode('acc_heading');?>">Account Details</h4>
        </div>
               ...
               <div class="card" style="border-radius:14px!important;">
                    ...
                    <br/><br/><br/>
                              <div class="card-body b">
                                  ...
                                  <div><a class="mod_tab" data-heading="Account Details" data-toggle="tab" href="#det"><i class="fa fa-user"></i> Account Details</a> </div>
                                  <br/>
                                  <div><a class="mod_tab" data-heading="Listing Details" data-toggle="tab" href="#add"><i class="fa fa-map-marker-alt"></i> Listing Address</a></div>
                                  <br/>
                                  <div><a class="mod_tab" data-heading="Payment Method" data-toggle="tab" href="#meth"><i class="fa fa-credit-card"></i> Payment Method</a></div>
...
<form id="<?=$comp->clean_encode('listing_details');?>" method="POST">
     ...
     <div class="form-group">
                          ...
                          <input type="hidden" name="h" value="<?=$seller_det['id'];?>" />
                         <div style="color:#555;padding-bottom:10px;" class="b">Listing Name</div>     
                            <input id="bp" type="text" name="lName" placeholder="$21" class="form-control" value="<?=$seller_det['name'];?>" style="background-color:#e6e6fa51"/>
                            <span class="errFirst four f-12 hide cl-red">Field cannot be left empty!</span>
                        </div>
                ...
                <div style="margin-bottom:20px">
                    <div style="color:#555;padding-bottom:10px;" class="b">Property Type</div>     
                    <!-- <input type="text" class="form-control" name="locality" placeholder="Townarea" value="Khalid" style="background-color:#e6e6fa51"/> -->
                    <select name="type" class="form-control bg-lav">
                    <?php
                      $types=['Apartment','Hostel','Girls Hostel','Boys Hostel','Guest House'];
                      foreach($types as $t){
                          if($t==$seller_det['type']){
                    ?>
                ...
                <div class="col-xs-6" style="padding:0px; margin-bottom:20px">
                    ...
                    <input type="text" class="form-control" name="city" placeholder="California" value="<?=$seller_det['city'];?>" style="background-color:#e6e6fa51"/>
                </div>
                <div class="col-xs-6" style="margin-bottom:20px">
                    <div style="color:#555;padding-bottom:10px;" class="b">Zip</div>     
                    <input type="text" class="form-control" name="zip" placeholder="9876" value="<?=$seller_det['zip'];?>" style="background-color:#e6e6fa51"/>
                </div>
...
<div class="tab-content">
  <div id="description" class="tab-pane fade in active">
      <form id="listing_description" method="POST">
        <div style="margin-bottom:20px;margin-top:20px">
          <textarea class="form-control" name="listDesc" placeholder="Describe your listing" style="background-color:#e6e6fa51;height:200px;"><?=str_replace("<br />", "\n", $seller_det['description']);?></textarea>
        </div>
        <div class="pull-right">
          <button type="submit" id="myBTNT" class="btn btn-primary"><i class="fa fa-sync"></i> Update</button>    
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </form>
    ...
    <div id="myFaci">
                     ...
                     <div id="newFaci" class="">
                         <br />
                         <h5 class="b">Select facilities you offer :</h5>
  ...
  var hostId='<?=base64_encode($seller_det['id']);?>';
    $(function() {
      ...
      $('.mod_tab').click(function(){
          $('#'+clean_encode('acc_heading')).text($(this).attr('data-heading'));
      })
...
$.ajax({
  url:"https://api.exchangeratesapi.io/latest?symbols=USD,USD&base=USD",
  type:'GET',
  success:function(data){
    console.log(data)
...
var id;
      ...
      $('#'+clean_encode('listing_details')).on('submit', function(event){
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            if(resp.err){
              ...
              $('#'+clean_encode('type')).text(resp.type);
              $('#'+clean_encode('address')).html(resp.address);
              $('#'+clean_encode('city')).text(resp.city);
              $('#'+clean_encode('zip')).text(resp.zip);
              console.log('sasd');
            }
          }
        });
      ...
      $('#listing_description').on('submit',function(event){
        event.preventDefault();
        ...
        $.ajax({
            ...
            data:form.serialize() + '&' + $.param({
              ...
              success:function(data){
                  var arr=JSON.parse(data);
                  console.log(arr);
                  $('#'+clean_encode('readableDesc')).html(arr.desc);
