...
if(!isset($_SESSION['requirement'])){
  $_SESSION['requirement']=array(
        ...
        'out'=>strtotime('+2 day', strtotime(date('Y-m-d'))),
        'gNum'=>1
    );
...
<body>
<!-- Gallery -->
<div id="overlay" class="bd">
<div class="col-xs-12 bg-grey pd-10 f-22 fixed" style="width:100%;">
<a href="javascript: window.history.back();"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp; <?=$det['name'];?> Gallery</a>
</div>
               ...
               for($i=0;$i<=3;$i++){
                ...
                <div class="col-xs-12 col-md-12 md-top-20 md-rt-10">
                    ...
                    <div class="col-xs-12" style="padding:0px;">
                        <img src='<?=$img[$i];?>' style="width:100%;height:70vh;object-fit:cover;" />
...
<!-- //Gallery -->
 ...
 <div class="header container-fluid pd-5" style="width:100%;z-index:+99;background-color:rgba(0,0,0,0);color:#fff;position:absolute;">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-12" style="padding:0px;color:#fff;">
                ...
                <img src="../profiles/<?=$det['im_1'];?>" style="width:100%;height:400px;object-fit:cover;" />

            </div>

            <div class="col-xs-12 col-sm-12 col-md-12 bg-lav md-top-10 pd-5 text-center hide">
                <?php
                    for($i=0;$i<=0;$i++){
                ?>
                    <img src="https://images.unsplash.com/photo-1523908511403-7fc7b25592f4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" style="width:80px;height:80px;object-fit:cover;margin:10px;" />
                <?php
}
                ?>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
               ...
               <div class="col-xs-12 col-sm-12 col-md-12">
                <br />
                <div class="col-xs-9 col-sm-6 col-md-10" style="padding:0px;">
                ...
                <div class="col-xs-3 col-sm-6 col-md-2 md-top-10">
                <h2>
                <a href="#gallery">
                    <span class="b cl-blue btn-pill bd pd-5"><i class="fa fa-images"></i></span>
                </a>
                </h2>
                </div>
           <br />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 md-top-30">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3" style="padding:0px;">
                    ...
                    <div class="col-xs-12 col-md-12 bg-grey bd md-top-30 md-btm-30">
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-4">
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 bg-lav bd md-top-10">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-12 md-top-10">
                            ...
                            <h5 class="cl-blue b"><span class="pointer" onclick="editToggle()"> <i class="fa fa-edit"></i> Edit requirements</span></h5>
                        ...
                        <div id="<?=clean_encode('editRequirement');?>" class="col-xs-12 col-sm-12 col-md-12 bg-lav hide bd md-top-10 pd-5">

                            <div class="col-xs-12 col-sm-12 col-md-12 pd-5">

                                <h4 class="pull-left b">Edit Requirements</h4>

                                <span onclick="editToggle()" class="pull-right pointer f-22">&times;</span>

                            </div>

                             <div>
                                <form id="requirements" mrthod="POST">
                                       ...
                                       <div class="col-xs-12 col-sm-12 col-md-6 md-top-10 pd-5">
                                            <div class="form-group">
                                                ...
                                                <!--<input type='text' class="form-control" id='datetimepicker1' />-->
                                                 ...
                                                 <input type='date' class="form-control" name="dateIn" onChange="setDate(this,&apos;inDate&apos;)" />
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 md-top-10 pd-5">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type='date' class="form-control" name="dateOut" onChange="setDate(this,&apos;outDate&apos;)" />
                         ...
                         <div id="<?=clean_encode('addedRoom_'.$c['id']);?>">
                            ...
                            <br/>
                             ...
                             <h5 class="b"><?=$c['roomName'];?>
                                 ...
                                 <span class="pull-right" onclick="removemyRoom('<?=$c['id'];?>')">

                                     <i class="fa fa-trash-alt"></i></span>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(resp, (key,index)=>{
                    ...
                    //finalBPrice=parseFloat(index.bPrice)*parseFloat(index.guestNum);
                    subTotal+=parseFloat(index.Total);

                    html+='<div id="'+clean_encode('addedRoom_'+index.id)+'"> <br/><h5 class="b">'+index.roomName+'<span class="pull-right" onclick="removemyRoom('+index.id+')"><i class="fa fa-trash-alt"></i></span> </h5> <div class="md-top-20"> <span class="bg-danger bd pd-10">'+index.availableBeds+' Beds Left!</span> </div> <br/> <div class="md-top-10"> <span class="b text-primary">Reservation Cost</span> <span class="b text-muted pull-right">'+index.bPrice+'</span> </div> <div class="md-top-10"> <span class="b text-primary">Hostel Cost</span> <span class="b text-muted pull-right">'+index.price+'</span> <div class="f-12 text-muted md-top-10"><i class="fa fa-info-circle"></i> Hostel Cost is according to bed per night and is payable when you reach the hostel.</div> </div> <div class="md-top-10"> <span class="b text-primary">Rs '+index.bPrice+' x '+index.guestNum+' Guests</span> <span class="b text-muted pull-right">Rs '+index.Total+'</span> </div></div>';

                })

                $('#myRooms').html(html);
                $('#payable').removeClass('hide');
                $('#payable>h4>span').text(subTotal);
...
// Put the object into storage
                ...
                $('#myRooms').append('<br/><h5 class="b">'+resp.roomName+'<span class="pull-right"><i class="fa fa-trash-alt"></i></span> </h5> <div class="md-top-20"> <span class="bg-danger bd pd-10">'+resp.availableBeds+' Beds Left!</span> </div> <br/> <div class="md-top-10"> <span class="b text-primary">Reservation Cost</span> <span class="b text-muted pull-right">'+resp.bPrice+'</span> </div> <div class="md-top-10"> <span class="b text-primary">Hostel Cost</span> <span class="b text-muted pull-right">'+resp.price+'</span> <div class="f-12 text-muted md-top-10"><i class="fa fa-info-circle"></i> Hostel Cost is according to bed per night and is payable when you reach the hostel.</div> </div> <div class="md-top-10"> <span class="b text-primary">Rs '+resp.price+' x 2 Guests</span> <span class="b text-muted pull-right">Rs 240</span> </div>');*/
          ...
          function removemyRoom(id){

              var elem=clean_encode('addedRoom_'+id);
              ...
              //console.warn(elem)
                  ...
                  success:function(data){
                      ...
                      var newTotal=JSON.parse(data);
                        ...
                        $('#payable>h4>span').text(newTotal[0].sub_total);    
          ...
          var s=clean_encode('editRequirement');
          ...
          function editToggle(){
            ...
            (flag) ? ($("#"+s).addClass('hide'), flag=false) : ($("#"+s).removeClass('hide'),flag=true);
    ...
    <script>
                          ...
                          //console.log('In: '+dateIn+' OUT: '+dateout);
...
$('.slider-nav').slick({
  ...
  success:function(data){
    ...
    console.log(35* oth);
            ...
            $("#requirements").on('submit', function(event){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        console.log(resp);
                            ...
                            $('#outDate').text(moment.unix(resp.requirements.in).format('ll'));
                            $('#inDate').text(moment.unix(resp.requirements.out).format('ll'));
                            $('#guestNum').text(resp.requirements.gNum);
                        if(resp.results){
                            var subTotal=0;
                            let html='';

                            $.each(resp.output, (key,index)=>{
