...
<body>
    ...
    <div class="container" style="background-image:url(https://img.freepik.com/free-vector/friendly-receptionists-from-hotel-registration-desk-help-clients_74855-4420.jpg?size=626&ext=jpg&ga=GA1.2.616904311.1600700940);background-repeat:no-repeat; height:350px; background-position: 100% 50%;">
        <div class="row">
<!--            <div class="col-xs-12 xs-hide col-sm-12 col-md-10" style="position:absolute;background-image:url(https://img.freepik.com/free-vector/friendly-receptionists-from-hotel-registration-desk-help-clients_74855-4420.jpg?size=626&ext=jpg&ga=GA1.2.616904311.1600700940);background-repeat:no-repeat; height:350px; background-position: 110% 50%;">
                
            </div>-->
            
            
            
            <div class="col-md-4 col-sm-8 col-xs-10 md-top-30">
            
                    <h2>Book unique listings from around the globe.</h2>
            
            <!--<div class="col-xs-12 col-sm-2 col-md-8">
                <img src="https://img.freepik.com/free-vector/friendly-receptionists-from-hotel-registration-desk-help-clients_74855-4420.jpg?size=626&ext=jpg&ga=GA1.2.616904311.1600700940" style="width:100%;height:250px;object-fit:cover;" />
            </div>-->
            </div>
            
            
            <!--//Search-->
            <div class="col-xs-12 col-sm-12 col-xs-12 md-top-30">
                 <form class="col-md-6 col-sm-8 col-xs-12"  style="background-color:#e6e6fa; height: 50px;padding: 0px;border-radius: 25px;" action="search.php" method="GET">

              <div class="col-md-11 col-sm-10 col-xs-10">
                <input id="search_bar" type="text" name="search" value="delhi" class="f-12" placeholder="Search for college,city or Hostel Name" style="width:100%;height:50px;border: none;display:inline;background-color:#e6e6fa;" autocomplete="off" >
              </div>
              <div class="col-md-1 col-sm-2 col-xs-2 f-15 text-muted text-center" style="padding:15px 8px 0px 0px;">
            ...
            <!--//Search-->
            <!--Types-->
            <div class="col-xs-12 col-sm-12 col-md-12 md-top-40">
                <br/><br/>
