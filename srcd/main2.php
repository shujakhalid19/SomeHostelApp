...
$cart = $pur->showMyRooms($_SESSION['cart']);
           ...
           <br />
            ...
            <!--CHECKOUT-->
                 <div class="col-xs-12 col-sm-12 col-md-4">
                     ...
                     <div id="myRooms" class="col-xs-12 col-sm-12 col-md-12 bd md-top-0 pd-10">
                         <?php
                            if(isset($cart)){
                                $subTotal=0;
                                foreach($cart as $c){
                         ...
                         <div id="<?=clean_encode('addedRoom_'.$c['id']);?>">
                            <br/>
                             ...
                             <div class="md-top-10">
                                 <span class="b text-primary">Rs <?=$c['price'];?></span>
                     ...
                     <div id="payable" class="col-xs-12 col-sm-12 col-md-12" style="padding:0px;">
                        <h4 class="bg-success md-top-0 pd-10">Payable Now
                            
                            <span class="b pull-right">$ <?=$subTotal;?></span>
                         </h4>
